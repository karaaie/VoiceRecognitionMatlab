...
%or
%[mfccs,spectgram,f,t]=GetSpeechFeatures(signal,fs,winlength,ncep)
%
...
function [varargout]=GetSpeechFeatures(signal,fs,winlength,varargin)
...
elseif (nargin == 4) && ((nargout == 1) || (nargout == 4)),
    ...
    error(['Incorrect number of inputs and outputs. Run '...
        '"help GetSpeechFeatures" for valid syntax examples.']);
end
